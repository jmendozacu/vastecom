...
class Cminds_Marketplace_Block_Report_Abstract extends Mage_Core_Block_Template {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()->joinInner(array('e' => $this->_getEntityIntTable()), 'e.entity_id = product_id', array('value') );
        $collection->getSelect()->where('e.value = ?', $this->_getSupplierId());
