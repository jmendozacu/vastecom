...
class Cminds_Marketplace_ShipmentController extends Cminds_Marketplace_Controller_Action {
    ...
    public function saveAction() {
        ...
        try {
            ...
            Mage::app()->getFrontController()->getResponse()->setRedirect(Mage::getUrl('*/order/view/', array('id' => $post['order_id'])));
        } catch (Exception $e) {
            ...
            Mage::app()->getFrontController()->getResponse()->setRedirect(Mage::getUrl('*/shipment/create/', array('id' => $post['order_id'])));
        }
    }
