...
class Cminds_Supplierfrontendproductuploader_Block_Product_List extends Mage_Core_Block_Template
{
    ...
    public function getItems() {
        ...
        switch($status) {
            case 'pending':
                $collection->addAttributeToFilter('frontendproduct_product_status', Cminds_Supplierfrontendproductuploader_Model_Product::STATUS_PENDING);
                break;
            case 'active':
                $collection->addAttributeToFilter('frontendproduct_product_status', Cminds_Supplierfrontendproductuploader_Model_Product::STATUS_APPROVED);
                break;
            case 'inactive':
                $collection->addAttributeToFilter('frontendproduct_product_status', Cminds_Supplierfrontendproductuploader_Model_Product::STATUS_NONACTIVE);
                break;
            case 'disapproved':
                $collection->addAttributeToFilter('frontendproduct_product_status', Cminds_Supplierfrontendproductuploader_Model_Product::STATUS_DISAPPROVED);
                break;
            default:
                break;
        }
