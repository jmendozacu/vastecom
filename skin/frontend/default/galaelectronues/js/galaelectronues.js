...
function showAgreementPopup(e) {
	...
	jQuery('#checkout-agreements label.a-click, .paypal-review-order label.a-click').parent().parent().children('.agreement-content').show()
		.css({
...
function hideAgreementPopup(e) {
	...
	jQuery('#checkout-agreements .agreement-content, .paypal-review-order .agreement-content').hide();
